...
\begin{lstlisting}
ANSWER_1 = None        # choose the correct vision task class
\end{lstlisting}
...
\textbf{Tip.} The vision task class returning 21 HAND landmarks (Hand + Landmarker).
...
\begin{lstlisting}
ANSWER_2 = None        # choose the function that draws dots + bones
\end{lstlisting}
...
\textbf{Tip.} A function reference (no parentheses) drawing dots+bones, not text.
...
\begin{lstlisting}
ANSWER_3 = None        # comparison operator as a string: "<" or ">"
\end{lstlisting}
...
\textbf{Tip.} Image y grows downward; an extended fingertip has the smaller y.
...
\begin{lstlisting}
ANSWER_4 = None        # comparison operator as a string: "<" or ">"
\end{lstlisting}
...
\textbf{Tip.} Right-hand extended thumb: tip x is greater than ip x.
...
\begin{lstlisting}
ANSWER_5 = None        # openness float for an EXTENDED finger (0.0..1.0)
\end{lstlisting}
...
\textbf{Tip.} The openness value for a fully EXTENDED/open finger, in [0.0, 1.0].
